...
export const createDashboardStyles = (theme: any) => StyleSheet.create({
  ...
  txDetailCard: { backgroundColor: theme.colors.card, borderTopLeftRadius: 32, borderTopRightRadius: 32, padding: 24, paddingBottom: 60 },
  txDetailHeader: { alignItems: 'center', marginBottom: 30 },
  txDetailTypeBadge: { paddingHorizontal: 16, paddingVertical: 6, borderRadius: 20, marginBottom: 12 },
  ...
  txDetailInfoSection: { backgroundColor: theme.colors.surface, borderRadius: 20, padding: 20, gap: 20 },
  ...
  txDetailDeleteBtn: { flex: 1, height: 50, borderRadius: 12, borderWidth: 1, borderColor: theme.colors.error, alignItems: 'center', justifyContent: 'center' },
  txDetailCloseBtn: { flex: 2, height: 50, borderRadius: 12, backgroundColor: theme.colors.primary, alignItems: 'center', justifyContent: 'center' },
});
